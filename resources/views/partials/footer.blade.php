<footer class="border-t border-white/10 bg-steel-900 text-white">
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="grid gap-10 md:grid-cols-3">
            <div>
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-display text-lg font-bold">CV Adzra Engineering</span>
                </div>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2 text-sm text-steel-400">
                    ...
                    <li>WhatsApp / Telepon: +62 812-3456-7890</li>
                    <li>Email: info@cvadzra.com</li>
                </ul>
            </div>
        ...
        <div class="mt-10 border-t border-white/10 pt-6 text-center text-xs text-steel-400">
            &copy; {{ date('Y') }} CV Adzra Engineering Bandung. Seluruh hak cipta dilindungi.
        </div>
    </div>
</footer>
