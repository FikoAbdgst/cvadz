...
@section('content')
    <section class="hero-glow relative overflow-hidden pt-32 pb-16 text-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <p class="hero-anim hero-anim-delay-1 label-mono text-amber-600">Profil Perusahaan</p>
            <h1 class="hero-anim hero-anim-delay-2 mt-3 font-display text-4xl font-bold">Tentang Kami</h1>
            <p class="hero-anim hero-anim-delay-3 mt-3 max-w-2xl text-steel-400">Perusahaan fabrikasi mesin industri yang berpusat di Bandung, Jawa Barat.</p>
        </div>
    </section>
    ...
    <section class="bg-paper-100 py-16 sm:py-24">
        <div class="mx-auto max-w-3xl space-y-8 px-4 text-graphite-500 sm:px-6">
            ...
            <div class="anim anim-fade-up anim-delay-2">
                <h2 class="font-display text-2xl font-bold text-graphite-900">Layanan Kami</h2>
                <ul class="mt-4 grid gap-4 sm:grid-cols-2">
                    <li class="plate anim anim-fade-up anim-delay-1 rounded bg-white p-5">
                    ...
                    <li class="plate anim anim-fade-up anim-delay-2 rounded bg-white p-5">
                        <span class="plate-corner-bl"></span>
                        <span class="plate-corner-br"></span>
                    ...
                    <li class="plate anim anim-fade-up anim-delay-3 rounded bg-white p-5">
                        <span class="plate-corner-bl"></span>
                        <span class="plate-corner-br"></span>
                    ...
                    <li class="plate anim anim-fade-up anim-delay-4 rounded bg-white p-5">
                        <span class="plate-corner-bl"></span>
                        <span class="plate-corner-br"></span>
